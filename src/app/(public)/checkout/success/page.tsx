                        ...
                        if (items.length > 0) {
                            try {
                                ...
                                await addDoc(collection(db, "donations"), {
                                    ...
                                    comment: (paymentIntent as any).metadata?.comment || donorInfo?.comment || "", // Save comment (Metadata or LocalStorage)
                                    campaignIds: items.map(item => item.id), // For filtering by campaign
                                    status: "Succeeded",
